  ...
  return (
    ...
    >
      <div className="container flex flex-col items-center ">
        <div className="grid grid-cols-1 lg:grid-cols-[60%_40%] w-full gap-8">
          {/* Logo column */}
          <div className="lg:block grid grid-cols-2 place-items-center">
            <a className="flex h-16 gap-2 mb-2 order-1" href="/">
            ...
            <div className="flex gap-4 px-5 order-3">
              <a
            ...
            <p
              className="text-gray-400 dark:text-gray-500 order-2"
              style={{ color: themeColors.secondryText }}
            >
              Home for programmers
            </p>
            <p
              className="text-gray-500 dark:text-gray-600 text-sm order-4"
              style={{ color: themeColors.secondryText }}
            >
