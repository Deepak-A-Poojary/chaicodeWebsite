...
const TermsAndConditons = () => {
  ...
  const [activeLink, setActiveLink] = useState("#terms_policy-0");
  ...
  const terms_of_service_details = [
    {
      title: "Overview",
      qt: "OVERVIEW",
      ans: [
        'This website is operated by ChaiCode. Throughout the site, the terms "we", "us" and "our" refer to ChaiCode. ChaiCode offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.',
    ...
    },
    {
      ...
      qt: "SECTION 1 - ONLINE STORE TERMS",
      ans: [
    ...
    },
    {
      ...
      qt: "SECTION 2 - GENERAL CONDITIONS",
      ans: [
    ...
    {
      title: "3 - Accuracy, completeness and timeliness of information",
      qt: "SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION",
      ans: [
    ...
    {
      title: "4 - Modifications to the service and prices",
      qt: "SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES",
      ans: [
    ...
    },
    {
      ...
      qt: "SECTION 5 - PRODUCTS OR SERVICES",
      ans: [
    ...
    },
    {
      ...
      qt: "SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION",
      ans: [
    ...
    },
    {
      ...
      qt: "SECTION 8 - THIRD-PARTY LINKS",
      ans: [
    ...
    {
      title: "9 - User comments, feedback and other submissions",
      qt: "SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS",
      ans: [
    ...
    },
    {
      ...
      qt: "SECTION 10 - PERSONAL INFORMATION",
      ans: [
    ...
    },
    {
      ...
      qt: "SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS",
      ans: [
    ...
    },
    {
      ...
      qt: "SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY",
      ans: [
        ...
        "In no case shall ChaiCode, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers or licensors be liable for any injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind, including, without limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability or otherwise, arising from your use of any of the service or any products procured using the service, or for any other claim related in any way to your use of the service or any product, including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result of the use of the service or any content (or product) posted, transmitted, or otherwise made available via the service, even if advised of their possibility.",
        "Because some states or jurisdictions do not allow the exclusion or the limitation of liability for consequential or incidental damages, in such states or jurisdictions, our liability shall be limited to the maximum extent permitted by law.",
      ],
    },
    {
      title: "14 - Indemnification",
      qt: "SECTION 14 - INDEMNIFICATION",
      ans: [
        "You agree to indemnify, defend and hold harmless ChaiCode and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys' fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.",
      ],
    },
    {
      title: "15 - Severability",
      qt: "SECTION 15 - SEVERABILITY",
      ans: [
    ...
    },
    {
      ...
      qt: "SECTION 17 - ENTIRE AGREEMENT",
      ans: [
    ...
    },
    {
      ...
      qt: "SECTION 19 - CHANGES TO TERMS OF SERVICE",
      ans: [
  ...
  useEffect(() => {
    ...
    terms_of_service_details.forEach((_, index) => {
      const id = `terms_policy-${index}`;
      ...
      const trigger = ScrollTrigger.create({
        ...
        onLeave: (self) => {
          if (
            index === terms_of_service_details.length - 1 &&
            self.direction === 1
          ) {
            setActiveLink(`#terms_policy-${index}`);
          }
        },
        onLeaveBack: (self) => {
          if (index === 0 && self.direction === -1) {
            setActiveLink("#terms_policy-0");
          }
        },
      });
  ...
  return (
    <div className="min-h-dvh md:p-10  text-center font-['outfit'] relative">
      <h1
        className={`text-5xl mt-10 p-2 md:mt-0 md:text-7xl font-bold ${
      ...
      <p className="m-5 text-lg px-0 xl:px-80">
        ...
        Our Most important term is that our platform does not allow users to
        share accounts or resell courses.
      </p>
      <div className="grid grid-cols-1 md:grid-cols-[35%_65%] mt-10 px-0 md:px-20 gap-8">
        ...
        >
          {terms_of_service_details.map((item, index) => (
            <div key={index} id={`terms_policy-${index}`} className="mb-10">
